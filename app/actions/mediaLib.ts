...
export type MediaLibAction = BeganContentUploadAction | 
    GotLocalIDAction | 
...
export const beganMediaUpload = (mediaInfo:MediaBasicInfo):BeganMediaUploadAction => ({
    type:'mediaLib/beganMediaUpload',
    data:mediaInfo
})

export const beganMetadataUpload = (mediaInfo:MediaBasicInfo):BeganMetadataUploadAction => ({
    type:'mediaLib/beganMetadataUpload',
    data:mediaInfo
})
export const finishedContentUpload = (contentID:string,contents:CompleteAnyMedia[]):FinishedContentUploadAction => ({
    type:'mediaLib/finishedContentUpload',
    data:{
        contentID,
        contents
...
export const contentUploadError = (error:Error|string|ErrMessage):ContentUploadErrorAction => {
    let message = ''
