 ...
 * @deprecated
 */
export default class ShockAvatar extends React.PureComponent<Props> {
...
const makeMapStateToProps = () => {
  ...
  const f = (
    ...
    ownProps: ConnectedProps & { navigation: Navigation },
  ): Props => {
...
const _ConnectedShockAvatar: React.FC<ConnectedProps> = connect(
  makeMapStateToProps,
)(ShockAvatar)
